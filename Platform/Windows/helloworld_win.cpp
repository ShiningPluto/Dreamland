...
void InitPipeline()
{
	...
	D3DReadFileToBlob(L"copyVS.cso", &VS);
	D3DReadFileToBlob(L"copyPS.cso", &PS);
...
void InitGraphics()
{
	...
	VERTEX OurVertices[] = {
		...
		{XMFLOAT3(0.45f, -0.5f, 0.0f), XMFLOAT4(0.f, 1.f, 0.f, 1.f)},
	...
	g_pDev->CreateBuffer(&bd, nullptr, &g_pVBuffer); // create the buffer
